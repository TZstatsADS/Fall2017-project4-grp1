...
>>>>>>> 653ab6c2c470a7bc8e6427530acc8213055417e7
```

## Convert raw dataset1
```{r}
...
# 
# 
# pearson_weight_MS <- cal_weight(Table_2,'pearson')
# spearman_weight_MS <- cal_weight(Table_2,'spearman')
# vector_weight_MS <- cal_weight(Table_2,'vector')
# 
...
#mat_significance_weight <- significance_weight_matrix(dim(Table_2)[1], mat = Table_2)
...
#mat_variance_weight <- variance_weight_matrix(dim(Table_2)[1], mat = Table_2)
